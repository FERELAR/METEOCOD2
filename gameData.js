...
METAR: {
easy: [
{code:"METAR UBBB 251600Z 27005MPS 99999 RA FEW030 20/16 Q1012 NOSIG=", errors:[5], hint:"Если бы факт про то что морковка улучшает зрение оказались правдивы..."},
{code:"METAR UUEE 251600Z 00000KT 9999 SCT040 69/10 Q1018", errors:[7], hint:"Тепленько)"}
],
medium: [
{code:"METAR ULLI 251630Z 18050MPS 8000 -RA BKN007 OVC030 03/M01 Q1002 NOSIG", errors:[4,6], hint:"Видимость и облачность"},
